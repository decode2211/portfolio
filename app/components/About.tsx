            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-xl text-gray-300 leading-relaxed">
                  ...
                  statistical analysis, and real-time ML inference. 143+ LeetCode problems solved.
              ...
              >
                <div className="grid grid-cols-3 gap-6 text-center">
                  ...
                  <div>
                    ...
                    <div className="text-gray-400 text-sm">Electronics and ML Engineer</div>
                  </div>
                </div>
              </motion.div>
            </div>

            {/* Right half: Highlights Grid */}
